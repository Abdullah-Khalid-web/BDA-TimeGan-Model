...
embedder = Embedder(input_dim=feature_dim, hidden_dim=HIDDEN_DIM, num_layers=args.num_layers, dropout=0.1)
recovery = Recovery(hidden_dim=HIDDEN_DIM, output_dim=feature_dim, num_layers=args.num_layers, dropout=0.1)
