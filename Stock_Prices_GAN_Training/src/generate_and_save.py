...
# ----------------- Parse Arguments -----------------
import argparse
parser = argparse.ArgumentParser(description='Generate synthetic samples using trained TimeGAN')
parser.add_argument("--data_dir", default="data/processed/stock_prices",
                    help="Path to processed data directory")
parser.add_argument("--ckpt_dir", default="outputs/checkpoints/timegan_wgan_gp",
                    help="Path to checkpoint directory")
parser.add_argument("--out_dir", default="outputs/synth",
...
if __name__ == "__main__":
    ...
    out_npy = os.path.join(OUT_DIR, f"synth_data_{N}w.npy")
    out_csv = os.path.join(OUT_DIR, f"synth_data_{N}w.csv")
